...
@Rule(name = "R_02",description = "el paciente presenta masas tiroideas")
public class pacientePresentaMasasTiroideas {

    @Condition
    public boolean when(Facts facts){

        patologiaFactorAsociada presente = facts.get("patologiasFactores");
        return presente.getDescripcion().equals("Masas tiroideas") && presente.isPresenta() && presente.isEsFactor() && !presente.isRevisado();

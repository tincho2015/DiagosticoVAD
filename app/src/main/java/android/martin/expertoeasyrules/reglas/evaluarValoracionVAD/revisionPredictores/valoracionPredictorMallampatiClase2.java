...
@Rule(name = "R_35",description = "Determinar valoración de la revision de los predictores",priority = 7)
public class valoracionPredictorMallampatiClase2 {

    @Condition
    public boolean when(Facts facts){

        resultadoPredictorMallampati rp = facts.get("resultadoPredictorMallampati");
        return !rp.isValorizado() && rp.getResultado().equals("Clase 2");

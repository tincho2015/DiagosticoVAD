...
@Rule(name = "R_74",description = "Determinar valoración de vía aérea dificil ",priority = 2)
public class valoracionSintomaObstruccion {
    ...
    public void then(Facts facts) throws Exception{
        ...
        revisionObstruccionVA revision = facts.get("revisionSintomas");
        revision.setValoracionObstruccion(3);

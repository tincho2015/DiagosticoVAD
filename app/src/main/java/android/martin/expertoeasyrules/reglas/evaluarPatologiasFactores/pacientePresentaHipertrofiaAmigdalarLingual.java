...
@Rule(name = "R_08",description = "El paciente presenta hipertrofia amigdalar lingual ")
public class pacientePresentaHipertrofiaAmigdalarLingual {

    @Condition
    public boolean when(Facts facts){

        patologiaFactorAsociada presente = facts.get("patologiasFactores");
        return presente.getDescripcion().equals("Hipertrofia amigdalar lingual") && presente.isPresenta() && presente.isEsFactor() && !presente.isRevisado();

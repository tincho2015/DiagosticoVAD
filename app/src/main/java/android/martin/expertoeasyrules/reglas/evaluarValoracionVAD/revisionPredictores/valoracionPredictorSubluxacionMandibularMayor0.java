...
@Rule(name = "R_35",description = "Determinar valoración de la revision de los predictores",priority = 14)
public class valoracionPredictorSubluxacionMandibularMayor0 {

    @Condition
    public boolean when(Facts facts){

        resultadoPredictorSubMandibular resultado = facts.get("resultadoPredictorSubMandibular");
        return !resultado.isValorizado() && resultado.getResultado().equals("Mayor a 0");

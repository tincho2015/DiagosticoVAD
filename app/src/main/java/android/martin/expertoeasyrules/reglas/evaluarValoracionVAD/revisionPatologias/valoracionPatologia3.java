...
@Rule(name = "R_73",description = "Determinar valoración de vía aérea dificil ")
public class valoracionPatologia3 {

    @Condition
    public boolean when(@Fact("revisionPatologia") revisionPatologiaFactor revisionPatologia){

        return revisionPatologia.getFactores().contains("NoAntecedentesViaAereaDificil") &&
    ...
    public void then(@Fact("revisionPatologia") revisionPatologiaFactor revisionPatologia) throws Exception{
        ...
        revisionPatologia.setValoracionPatologias(5);
    }
}

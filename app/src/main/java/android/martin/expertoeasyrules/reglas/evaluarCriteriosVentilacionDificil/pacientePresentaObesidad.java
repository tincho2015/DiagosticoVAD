...
@Rule(name = "R_12",description = "El paciente presenta obesidad")
public class pacientePresentaObesidad {

    @Condition
    public boolean when(Facts facts){

        criterioVentilacionDificil presente = facts.get("criterios");
        return presente.getDescripcion().equals("Obesidad") && presente.isPresente() && !presente.isRevisado();

...
@Rule(name = "R_32",description = "El paciente pesenta signos de Disfonia",priority = 3)
public class presentaSintomaDisfonia {

    @Condition
    public boolean when(Facts facts){

        sintomaObstruccionVA presente = facts.get("sintomas");
        return presente.getDescripcion().equals("Disfonia") && presente.isPresente() && !presente.isRevisado();

...
@Rule(name = "R_06",description = "El paciente presenta macroglosia ")
public class pacientePresentaMacroglosias {

    @Condition
    public boolean when(Facts facts){

        patologiaFactorAsociada presente = facts.get("patologiasFactores");
        return presente.getDescripcion().equals("Macroglosia") && presente.isPresenta() && presente.isEsFactor() && !presente.isRevisado();

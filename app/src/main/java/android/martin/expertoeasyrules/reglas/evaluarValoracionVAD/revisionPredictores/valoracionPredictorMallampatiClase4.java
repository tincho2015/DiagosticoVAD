...
@Rule(name = "R_35",description = "Determinar valoración de la revision de los predictores",priority = 9)
public class valoracionPredictorMallampatiClase4 {

    @Condition
    public boolean when(Facts facts){

        resultadoPredictorMallampati rp = facts.get("resultadoPredictorMallampati");
        return !rp.isValorizado() && rp.getResultado().equals("Clase 4");

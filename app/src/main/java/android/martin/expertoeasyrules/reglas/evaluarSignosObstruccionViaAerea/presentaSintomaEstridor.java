...
@Rule(name = "R_34",description = "El paciente pesenta signos de Disfagia",priority = 5)
public class presentaSintomaEstridor {

    @Condition
    public boolean when(Facts facts){

        sintomaObstruccionVA presente = facts.get("sintomas");
        return presente.getDescripcion().equals("Estridor") && presente.isPresente() && !presente.isRevisado();
